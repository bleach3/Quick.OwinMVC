...
namespace Quick.OwinMVC.Middleware
{
    public class ImgViewMiddleware : AbstractPluginPathMiddleware, IPropertyHunter
    {
        ...
        public override Task Invoke(IOwinContext context, string plugin, string path)
        {
            ...
            //App.Core.Utils.Helper.Kernel32OutputDebugString2.COutputDebugString($"*** ImgViewMiddleware 22222 Path={context.Request.Uri.OriginalString} ,Expires={Expires},ViewFileSuffix={ViewFileSuffix} ");
